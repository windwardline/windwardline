...
| [Levelflow Cloud](https://github.com/windwardline/levelflow-cloud) | Disciplined market review — RLS on all 14 tables, fail-closed analyzer, ~1,300 tests | [levelflow.windwardline.com](https://levelflow.windwardline.com) |
...
Gartner, advising executives on technology strategy. Then the US Navy as an
Information Professional Officer in Information Warfare — accountable for the
networks a fleet relies on when nothing else is working.

**mlp@windwardline.com**
